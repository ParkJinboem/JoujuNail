...
public class FootPaintSceneController : MonoBehaviour, IFreeable
{
    [Header("Behaviour")]
    ...
    public void ChageAlphaPatternObject(int alphaNumber)
    {
        ...
        Image image = patternClone.GetComponent<Image>();
    ...
    public void SelectFinger(int fingerNum)
    {
        ...
        toesNailButtons[fingerNum].interactable = false;
    ...
    public void ChangeBrushSize(int size = 0)
    {
    ...
    public void PaintSelectFinger(int fingerNum)
    {
        ...
        selectPaintEngine = toesPaintEngines[fingerNum];
